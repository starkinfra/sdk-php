...
class Log extends Resource
{
    ...
    Receive an enumerator of PixReversal\Log objects previously created in the Stark Infra API
    ...
    ## Return:
        - enumerator of PixReversal\Log objects with updated attributes
     */
