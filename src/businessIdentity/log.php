...
namespace StarkInfra\BusinessIdentity;
...
class Log extends Resource
{
    ...
    ## Attributes (return-only):
        ...
        - identity [BusinessIdentity]: Business Identity entity to which the log refers to.
        - errors [array of strings]: array of errors linked to this Business Identity event
    ...
    Receive an enumerator of BusinessIdentity\Log objects previously created in the Stark Infra API.
    ...
    ## Parameters (optional):
        ...
        - ids [array of strings, default null]: Log ids to filter BusinessIdentity Logs. ex: ["5656565656565656", "4545454545454545"]
        - types [array of strings, default null]: filter for log event types. ex: ["created", "updated", "canceled", "processing", "success", "failed"]
        - identityIds [array of strings, default null]: array of BusinessIdentity ids to filter logs. ex: ["5656565656565656", "4545454545454545"]
        - user [Organization/Project object, default null]: Organization or Project object. Not necessary if StarkInfra\Settings::setUser() was used before function call

    ## Return:
        - enumerator of BusinessIdentity\Log objects with updated attributes
     */
    ...
    private static function resource()
    {
        $identityLog = function ($array) {
            $businessIdentity = function ($array) {
                return new BusinessIdentity($array);
            };
            $array["identity"] = API::fromApiJson($businessIdentity, $array["identity"]);
            return new Log($array);
        };
        return [
            "name" => "BusinessIdentityLog",
            "maker" => $identityLog,
        ];
    }
}
