...
class Log extends Resource
{
    ...
    ## Attributes:
        ...
        - errors [array of strings]: list of errors linked to this PixKey event
    ...
    */    
    ...
    ## Parameters (optional):
        - ids [array of strings, default null]: Log ids to filter PixKey Logs. ex: ["5656565656565656"]
        - limit [integer, default 100]: maximum number of objects to be retrieved. Max = 100. ex: 35
        - after [Date or string, default null] date filter for objects created only after specified date. ex: "2020-04-03"
        - before [Date or string, default null] date filter for objects created only before specified date. ex: "2020-04-03"
        - types [array of strings, default null]: filter retrieved objects by types. ex: "created","registered","updated","failed","canceling" and "canceled".
        - keyIds [array of strings, default null]: list of PixKey IDs to filter retrieved objects. ex: ["5656565656565656", "4545454545454545"]
        - user [Organization/Project object, default null]: Organization or Project object. Not necessary if StarkInfra\Settings::setUser() was set before function call
