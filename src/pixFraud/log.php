...
class Log extends Resource
{
    ...
    ## Attributes (return-only):
        ...
        - errors [array of strings]: array of errors linked to this PixFraud event.
    ...
    function __construct(array $params)
    {
        ...
        $this-> fraud = Checks::checkParam($params, "fraud");
    ...
    Receive an enumerator of PixFraud\Log objects previously created in the Stark Infra API

    ## Parameters (optional):
        - limit [integer, default null]: maximum number of objects to be retrieved. Unlimited if null. ex: 35
        - after [Date or string, default null] date filter for objects created only after specified date. ex: "2020-04-03"
        - before [Date or string, default null] date filter for objects created only before specified date. ex: "2020-04-03"
        - types [array of strings, default null]: filter retrieved objects by types. ex: "created", "failed", "registered", "canceled"
        - fraudIds [array of strings, default null]: array of PixFraud ids to filter retrieved objects. ex: ["5656565656565656", "4545454545454545"]
        - ids [array of strings, default null]: list of ids to filter retrieved objects. ex: ["5656565656565656", "4545454545454545"]
        - user [Organization/Project object, default null]: Organization or Project object. Not necessary if StarkInfra\Settings::setUser() was used before function call

    ## Return:
        - enumerator of PixFraud\Log objects with updated attributes
     */
    ...
    ## Parameters (optional):
        ...
        - before [Date or string, default null] date filter for objects created only before specified date. ex: "2020-04-03"
        - types [array of strings, default null]: filter retrieved objects by types. ex: "created", "failed", "registered", "canceled"
        - fraudIds [array of strings, default null]: list of PixFraud ids to filter retrieved objects. ex: ["5656565656565656", "4545454545454545"]
        - ids [array of strings, default null]: list of ids to filter retrieved objects. ex: ["5656565656565656", "4545454545454545"]
    ...
    {
        $fraudLog = function ($array) {
            $fraud = function ($array) {
                return new PixFraud($array);
            };
            $array["fraud"] = API::fromApiJson($fraud, $array["fraud"]);
