...
namespace StarkInfra\IssuingRestock;
...
class Log extends Resource
{
    ...
    function __construct(array $params)
    {
        ...
        $this->restock = Checks::checkParam($params, "restock");
    ...
    Receive a single IssuingRestock\Log object previously created in the Stark Infra API by passing its id
    ...
    Receive an enumerator of IssuingRestock\Log objects previously created in the Stark Infra API
    ...
    ## Parameters (optional):
        ...
        - restockIds [array of strings, default null]: array of IssuingRestock ids to filter logs. ex: ["5656565656565656", "4545454545454545"]
        - ids [array of strings, default null]: list of ids to filter retrieved objects. ex: ["5656565656565656", "4545454545454545"]
        - user [Organization/Project object, default null]: Organization or Project object. Not necessary if StarkInfra\Settings::setUser() was used before function call

    ## Return:
        - enumerator of IssuingRestock\Log objects with updated attributes
     */
    ...
    {
        $restockLog = function ($array) {
            $restock = function ($array) {
                return new IssuingRestock($array);
            };
            $array["restock"] = API::fromApiJson($restock, $array["restock"]);
            return new Log($array);
        };
        return [
            "name" => "IssuingRestockLog",
            "maker" => $restockLog,
        ];
    }
}
