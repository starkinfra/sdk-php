...
use StarkInfra\Utils\URL;
use StarkInfra\Error\InputErrors;
use StarkInfra\Error\InternalServerError;
use StarkInfra\Error\UnknownError;
...
class Request
{
    public static function fetch($user, $method, $path, $payload = null, $query = null, $version = "v2")
    {
        ...
        if (is_null($user)) {
            throw new Exception("A user is required to access our API. Check our README: https://github.com/starkinfra/sdk-php/");
        }
        ...
        $headers = [
            ...
            "User-Agent" => "PHP-" . phpversion() . "-SDK-Infra-0.3.0",
