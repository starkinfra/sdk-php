...
class PixKeyHolmes extends Resource
{
    ...
    ## Parameters (optional):
        ...
        - status [array of strings, default null]: filter for status of retrieved objects. The live API accepts only "solved" or "solving" as filter values. ex: ["solved", "solving"]
