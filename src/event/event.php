...
class Event extends Resource
{
    ...
    ## Attributes (return-only):
        ...
        - subscription [string]: service that triggered this event. Options: "issuing-card", "pix-request.in", "pix-reversal.in", "pix-reversal.out", "pix-key", "pix-claim", "pix-infraction", "pix-chargeback", "pix-dispute", "pix-pull-subscription", "pix-pull-request", "issuing-card", "issuing-invoice", "issuing-purchase", "credit-note"
