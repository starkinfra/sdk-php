...
namespace StarkInfra\BusinessAttachment;
...
class Log extends Resource
{
    ...
    ## Attributes (return-only):
        ...
        - attachment [BusinessAttachment]: Business Attachment entity to which the log refers to.
        - errors [array of strings]: array of errors linked to this Business Attachment event
    ...
    Receive an enumerator of BusinessAttachment\Log objects previously created in the Stark Infra API.
    ...
    ## Parameters (optional):
        ...
        - ids [array of strings, default null]: Log ids to filter BusinessAttachment Logs. ex: ["5656565656565656", "4545454545454545"]
        - types [array of strings, default null]: filter for log event types. ex: ["created", "canceled", "approved", "denied"]
        - attachmentIds [array of strings, default null]: array of BusinessAttachment ids to filter logs. ex: ["5656565656565656", "4545454545454545"]
        - user [Organization/Project object, default null]: Organization or Project object. Not necessary if StarkInfra\Settings::setUser() was used before function call

    ## Return:
        - enumerator of BusinessAttachment\Log objects with updated attributes
     */
    ...
    private static function resource()
    {
        $attachmentLog = function ($array) {
            $businessAttachment = function ($array) {
                return new BusinessAttachment($array);
            };
            $array["attachment"] = API::fromApiJson($businessAttachment, $array["attachment"]);
            return new Log($array);
        };
        return [
            "name" => "BusinessAttachmentLog",
            "maker" => $attachmentLog,
        ];
    }
}
