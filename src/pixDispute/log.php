...
class Log extends Resource
{
    ...
    Every time a PixDispute entity is updated, a corresponding PixDispute\Log
    ...
    ## Attributes (return-only):
        ...
        - dispute [PixDispute]: Pix Dispute entity to which the log refers to.
        - errors [array of strings]: array of errors linked to this Pix Dispute event
        - type [string]: type of the Pix Dispute event which triggered the log creation. ex: "canceled", "created", "expired", "failed", "refunded", "registered", "sending", "sent", "signed", "success"
    ...
    function __construct(array $params)
    {
        ...
        $this-> dispute = Checks::checkParam($params, "dispute");
    ...
    Receive an enumerator of PixDispute\Log objects previously created in the Stark Infra API.
    ...
    ## Parameters (optional):
        ...
        - ids [array of strings, default null]: array of PixDispute\Log ids to filter logs. ex: ["5656565656565656", "4545454545454545"]
        - disputeIds [array of strings, default null]: array of PixDispute ids to filter logs. ex: ["5656565656565656", "4545454545454545"]
        - user [Organization/Project object, default null]: Organization or Project object. Not necessary if StarkInfra\Settings::setUser() was used before function call

    ## Return:
        - enumerator of PixDispute\Log objects with updated attributes
     */
